...
function(shaderc_combine_static_lib new_target target)
    ...
    elseif (APPLE)
        ...
        if (${CMAKE_CONFIGURATION_TYPES})
            file(GENERATE OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/${new_target}$<$<CONFIG:Debug>:d>$<$<CONFIG:RelWithDebInfo>:rd>.ar"
                    CONTENT ${build_script_file}
                    CONDITION 1)

            add_custom_command(OUTPUT ${libname}
                    DEPENDS ${all_libs}
                    COMMAND ${CMAKE_AR} -M < ${new_target}$<$<CONFIG:Debug>:d>$<$<CONFIG:RelWithDebInfo>:rd>.ar)
        else()
